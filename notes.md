...
- **[recipe_bucktsong_awe](https://github.com/kamperh/recipe_bucktsong_awe)**: A complete recipe for the unsupervised acoustic word embedding methods described in [arXiv'18](https://arxiv.org/abs/1811.00403). Methods are evaluated on the Buckeye English and NCHLT Xitsonga datasets.
