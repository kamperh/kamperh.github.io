...
I am a researcher in machine learning with a focus on speech processing. [My group]({{site.url}}/people/) develops methods that allow machines to acquire language autonomously, using as little supervision as possible. Through this, we hope to gain new insights into machine and human learning.
