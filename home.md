...
I am a lecturer in [E&E engineering](http://www.ee.sun.ac.za/) at [Stellenbosch University](http://www.sun.ac.za/), South Africa. Before moving (back) to South Africa, I did a postdoc at [Toyota Technological Institute](http://www.ttic.edu/) at Chicago, where I worked with [Karen Livescu](http://ttic.uchicago.edu/~klivescu/) and [Greg Shakhnarovich](http://ttic.uchicago.edu/~gregory/) on multi-modal machine learning models that combine speech and vision. I obtained my PhD in 2016 from the [University of Edinburgh](http://www.ed.ac.uk/), where I was supervised by [Sharon Goldwater](http://homepages.inf.ed.ac.uk/sgwater/), [Aren Jansen](http://old-site.clsp.jhu.edu/~ajansen/) and [Simon King](http://homepages.inf.ed.ac.uk/simonk/). The topic of my PhD thesis was unsupervised speech processing, and I played around with unsupervised Bayesian and neural models.
